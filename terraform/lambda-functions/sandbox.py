...
def build_security_finding(account, region, actor, event_name, source_ip, detected_at, remediation) -> dict:
...
def build_subject() -> str:
    return f"[Aegis/High] Security Group Exposure Alert"
